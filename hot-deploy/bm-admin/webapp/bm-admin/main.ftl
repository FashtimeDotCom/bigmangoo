...
<head>
    ...
    <!-- Bootstrap -->
    <link href="/bm-admin/images/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- styles -->
    <link href="/bm-admin/images/css/styles.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <!-- Logo -->
                <div class="logo">
                    <h1><a href="index.html">BigMangoo 后台管理</a></h1>
                </div>
            </div>
            <div class="col-md-5">
                <div class="row">
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    <!-- Main menu -->
                    <li class="current"><a href="index.html"><i class="glyphicon glyphicon-home"></i> 首页</a></li>
                    <li><a href="calendar.html"><i class="glyphicon glyphicon-calendar"></i> 会员管理</a></li>
                    <li class="submenu">
                        <a href="#">
                            <i class="glyphicon glyphicon-list"></i> 订单管理
                            <span class="caret pull-right"></span>
                        </a>
                        <!-- Sub menu -->
                        <ul>
                            <li><a href="login.html">天猫订单</a></li>
                            <li><a href="signup.html">淘宝订单</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<script src="/bm-admin/images/bootstrap/js/bootstrap.min.js"></script>
<script src="/bm-admin/images/js/custom.js"></script>
</body>
</html>